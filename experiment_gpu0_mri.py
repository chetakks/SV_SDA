...
results_dir = 'results/test_bbbc_batch_gpu0/'
results_dir = 'results/test_mri_gpu0/'
results_dir = 'results/test_bio_gpu0/'

params = {
'finetune_lr':0.1,
'pretraining_epochs':80,#60,#120,#80,#40,#15
'pretrain_lr':0.001,
'training_epochs': 100, #2,#
'hidden_layers_sizes':[1000,1000,1000], #[15,15,15], , ## [15],# [24 * 24, 20 * 20, 16 * 16], #[1000,1000,1000], # [5,5],#[100,200,300], #
'batch_size':1,         
...
experiments = [['BL'   , 'bio',                      None,     None    , None       ],]
#experiments = [['BL'   , 'mri',                      None,     None    , None       ],]
