...
def dataset_details(data_name, reduce=None):
    ...
    data_path='/media/883E0F323E0F1938/Chetak/Dataset/csip/pickled/'
    if reduce == None:
...
def load_dataset(data_name,reduce=None,samples=None, frac=None, rng_seed=None):
    ''' Loads the dataset
    :type dataset: string
    ...
    host_path = os.getenv('HOME')
    data_path=host_path+'/store/Datasets/pickled/'
    data_path='/media/883E0F323E0F1938/Chetak/Dataset/pickled/'
