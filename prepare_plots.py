...
if __name__ == "__main__":
    ...
    raw_data_dir = '../../misc/raw_data/'
#     #data_dir = 'data/'
    data_dir = 'data/shape100/'
#     results_dir = 'results/neurons300/'
    #data_dir = 'data/shape30new/'
#     data_dir = 'data/shape_lesscomplex/'
    #results_dir = 'results/neurons100/'
    #results_dir = 'results/neurons100_2/'
#     results_dir = 'results/neurons100_2a/'
    #results_dir = 'results/final_neurons100_pt45_ft01/'
    #results_dir = 'results/canonical/'
    #results_dir = 'results/tune_canonical/canonical_50_50_neurons/'
    #results_dir = 'results/tune_canonical/canonical_pt90/'
    #results_dir = 'results/tune__lesscomplex/canonical_pt15/'
    #results_dir = 'results/tune__lesscomplex/canonical_bw_pt15_moretesterr/'
    #results_dir = 'results/tune__lesscomplex/canonical_ramdomseed/'
    #results_dir = 'results/test/TL_pt120_reduction/'
    #results_dir = 'results/test/ordinal/'
    #results_dir = 'results/test/Large_TL/'
    ...
    """
    data_dir = 'data_sh/'
    prepare_Xs1(data_dir)
    
    prepare_Xd1(data_dir)
    show_samples(data_dir,'Xd1_ori_full'    ,10)

    prepare_Xl1(raw_data_dir,data_dir)
    show_samples(data_dir,'Xl1_ori_full'    ,10)

    prepare_Xd2(raw_data_dir,data_dir)
    show_samples(data_dir,'Xd2_ori_full'    ,10)
    """
    ...
    #training_data_fractions = [0.30,0.40,0.50,1.00]
